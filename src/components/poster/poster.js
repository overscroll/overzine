      ...
      <svg>
        <defs>
          ...
          <pattern id={backgroundImageName} patternUnits="userSpaceOnUse" width="100%" height="100%">
            <image xlinkHref={background} x="0" y="0" filter="url(#background-filter)" width="100%" height="100%" preserveAspectRatio="xMaxYMax slice" externalresourcesrequired="true"></image>
          </pattern>
