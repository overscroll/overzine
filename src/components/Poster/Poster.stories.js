...
stories
  .add('standard', () => <Poster content={article} {...actions} />)
  .add('all-properties-knobs', () => <Poster content={{
  ...
  .add('png-on-zine', () => <Poster content={{
    ...article,
  ...
  .add('pngduotone-on-zine', () => <Poster content={{
    ...article,
    headline: 'select',
    background: 'zine1',
  ...
  .add('bg1-duotone', () => <Poster content={{
    ...article,
    headline: 'Hello :)',
    background: '/images/eyes.jpg',
    backgroundEffect: 'duotone',
  ...
  .add('bg-with-gif', () => <Poster content={{
    ...article,
    headline: 'Hello :)',
  ...
  .add('bg-with-gif-duotone', () => <Poster content={{
    ...article,
    headline: 'Hello :)',
    backgroundEffect: 'duotone',
    background: 'https://66.media.tumblr.com/f5b38458c8e1908ece9e6d85bb9d5949/tumblr_nliyi8SsO01qc0s10o1_500.gif',
  ...
  .add('black', () => <Poster content={{
    ...article, state: 'TASK_ARCHIVED', backgroundColor: '#232323', image: '/images/objects/photo.png',
  }} {...actions} />)
  .add('black2', () => <Poster content={{
    ...article, state: 'TASK_ARCHIVED', backgroundColor: '#232323', backgroundColor2: '#C5C5C5', image: '/images/objects/photo.png',
  }} {...actions} />)
  .add('overscroll-gif', () => <Poster content={{
    ...article, state: 'TASK_ARCHIVED', backgroundColor: color('BackgroundColor', '#003576', ''), colorContrast: color('contrast', '#50E0E3'), backgroundColor2: '#003576', image: '/images/objects/password.png',
  }} {...actions} />)
  .add('external-gif', () => <Poster content={{
    ...article, state: 'TASK_ARCHIVED', backgroundColor: color('BackgroundColor', '#4A90E2', ''), colorContrast: color('contrast', '#FEFF20'), backgroundColor2: '#C5C5C5', image: 'https://media.giphy.com/media/9tXsPh8IcW68X23udg/giphy.gif',
  }} {...actions} />);
